...
class __TwigTemplate_dfff3832792c8861e0dc8d131ed565e2 extends Template
{
    private $source;
    private $macros = [];
...
($context["region"] ?? null) == "content_bottom")) ? ("row") : (""))];
        ...
        if (($context["content"] ?? null)) {
            // line 9
            yield "  <div";
            yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(CoreExtension::getAttribute($this->env, $this->source, ($context["attributes"] ?? null), "addClass", [($context["classes"] ?? null)], "method", false, false, true, 9), 9, $this->source), "html", null, true);
            yield ">
    ";
            // line 10
...
";
    ...
    {
        return new Source("", "themes/contrib/socialbase/templates/layout/region.html.twig", "/Applications/MAMP/htdocs/opensocial/html/themes/contrib/socialbase/templates/layout/region.html.twig");
    }
